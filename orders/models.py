...
class RefundRequest(models.Model):
  ...
  status = models.CharField(max_length=20,choices=STATUS_CHOICES,default="pending")  #get_status_display() to display the Label of choices
  created_at = models.DateTimeField()
  
  def __str__(self):
    return f"Refund of Order #{self.order.id} - {self.status}"  